...
Hello, I'm Nicolas Herment. Artisan HAM Kits is a side project I run from my office during evenings and weekends as a one-man operation.
...
Artisan HAM Kits came to life from a simple frustration: I was looking for power supply kits I could assemble myself for my amateur radio station. The choice was either buying commercial units made in the far east or spending countless hours chasing down individual components from existing open designs scattered across various suppliers.
...
However I'm now spending even more countless hours chasing down components and testing designs...

## The Approach

Every kit is carefully prepared by me in Sweden, ensuring quality component selection and proper documentation. The kits are built on proven, open-source designs from respected engineers in the amateur radio community.
...
- **Quality Selection:** I carefully select components to ensure reliable operation.
- **Builder-Friendly:** Whether you want a complete disassembled kit for the full building experience, a partially assembled unit, or buy the components yourself, pick the option you prefer.
- **Clear Documentation:** Each kit comes with comprehensive documentation and support.
- **Local providers** I try to source as many components as possible from European manufacturers. This is not easy. For example most passive components are not from Europe. This is something I'm constantly looking to improve.
